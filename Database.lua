...
MSC.WeightDB = {
    ...
    ["WARRIOR"] = {
        ...
        ["Hybrid"]     = { ["ITEM_MOD_STAMINA_SHORT"]=1.5, ["ITEM_MOD_CRIT_RATING_SHORT"]=1.5, ["ITEM_MOD_STRENGTH_SHORT"]=1.2, ["ITEM_MOD_AGILITY_SHORT"]=1.0, ["ITEM_MOD_WEAPON_SKILL_RATING_SHORT"]=2.0 }, 
    },
    ["HUNTER"] = {
...
-- 3. ENCHANT DATABASE (v2.0: Multi-Stat Support for Naxx/ZG)
MSC.EnchantDB = {
