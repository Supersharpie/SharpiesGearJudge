...
function MSC.ToggleMainMenu()
    ...
    f.SubTitle = f.Header:CreateFontString(nil, "OVERLAY", "GameFontHighlight"); f.SubTitle:SetPoint("BOTTOMLEFT", f.Title, "BOTTOMRIGHT", 10, 2); f.SubTitle:SetText("v2.3.1 Laboratory"); f.SubTitle:SetTextColor(MSC.GetClassColor())
