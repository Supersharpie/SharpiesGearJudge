...
function MSC.CreateOptionsFrame()
    ...
    local credits = f:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall"); credits:SetPoint("BOTTOM", f, "BOTTOM", 0, 15); credits:SetTextColor(0.5, 0.5, 0.5); credits:SetText("Author: Supersharpie (v1.9.1)")
