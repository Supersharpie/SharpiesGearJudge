...
**Sharpie's Gear Judge** is a professional-grade theorycrafting and stat comparison tool for World of Warcraft: Classic Era. It goes beyond simple tooltip numbers by analyzing your talent spec, racial bonuses, weapon speeds, and current enchants to tell you if an item is *actually* an upgrade for your specific character.
...
* `/sgj options` — Open the **Verdict Settings** (Toggle Enchants, Manual Spec Selection).
